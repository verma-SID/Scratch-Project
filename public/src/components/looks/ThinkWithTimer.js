...
const ThinkWithTimer = ({ character, comp_id }) => {
  ...
  return (
    <div 
    id={comp_id}
    onBlur={() => displayMessage()}
    style={t1} className="flex justify-center items-center">
      <div className="rounded text-center text-sm ">
      <div className="flex flex-row justify-between w-42 mx-4">
          <div className="text-white">Message</div>
          <input
            className="ml-2 w-32 text-center rounded-lg"
            type="text"
        ...
        <div className="flex flex-row mt-1 justify-between w-42 mx-4">
          <div className="text-white">Timer:</div>
          <input
           className="mx-2 text-center w-16 rounded-lg"
            type="number"
