...
const PointToMousePointer = ({character, characterAngle, comp_id}) => {
  ...
  return (
    ...
    style={t1} className="flex justify-center items-center">
      <div
        id={comp_id}
        className={`flex flex-col text-center rounded text-white text-sm cursor-pointer mx-auto`}
      ...
      >
        ...
        <select
          ...
          className="text-black text-center w-28 rounded-lg ml-2"
        >
        ...
        <div
          id={comp_id}
          className="text-center text-white w-42 text-sm cursor-pointer"
        >
